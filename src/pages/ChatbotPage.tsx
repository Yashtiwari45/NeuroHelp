  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="bg-gray-800/50 rounded-xl p-6">
        ...
        {/* Sample Questions UI Block (always visible) */}
      ...
      {/* Input form appears directly below header */}
      <form onSubmit={handleSubmit} className="p-4 border-t border-gray-700 bg-gray-800/50 rounded-xl">
      ...
      {/* Chat messages with additional spacing */}
      <div className="bg-gray-800/50 rounded-xl h-[400px] overflow-y-auto p-6 space-y-4">
